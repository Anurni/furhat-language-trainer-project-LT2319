...
const dmMachine = setup({
  ...
  states: {
    ...
    SkillLevelStateSpeak: {
      invoke: {
        src: "fhSpeak",
        input: { message : "Amazing! Now, what can you tell me about your skill level? Would you describe yourself as a beginner, intermediate or advanced learner? After your answer, you need to gimme a second to think."},
        onDone: {
